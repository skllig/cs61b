...
public class DrawUtls {
     ...
     */
    public static void drawHorizontalLine(TETile[][] world, Random r, Position p, int length, TETile t) {
     ...
     * @param t         Tile type of line
     */
    public static void drawVerticalLine(TETile[][] world, Random r, Position p, int length, TETile t) {
     ...
     */
    public static void drawRectangleInner(TETile[][] world, Random r, Rectangle rtg, TETile t) {
        for (int i = rtg.leftDown.y + 1; i < rtg.leftUp.y; i++) {
            drawHorizontalLine(world, r, new Position(rtg.leftDown.x + 1, i), rtg.getWidth() - 2, t);
            t = TETile.colorVariant(t, 15, 15, 15, r);
        }
    }
     ...
     */
    public static Rectangle drawRectangle(TETile[][] world, Random r, Rectangle rtg, TETile t, TETile fill) {
    ...
    public static boolean verifyRectangle(Rectangle rtg) {
        if (rtg.leftUp.x < 0 || rtg.leftUp.x >= Game.WIDTH || rtg.leftUp.y < 0 || rtg.leftUp.y >= Game.HEIGHT) {
            return false;
        }
        if (rtg.rightUp.x < 0 || rtg.rightUp.x >= Game.WIDTH || rtg.rightUp.y < 0 || rtg.rightUp.y >= Game.HEIGHT) {
            return false;
        }
        if (rtg.leftDown.x < 0 || rtg.leftDown.x >= Game.WIDTH || rtg.leftDown.y < 0 || rtg.leftDown.y >= Game.HEIGHT) {
            return false;
        }
        return true;
    }
     ...
     */
    public static void joinTop(TETile[][] world, Random r, Rectangle top, Rectangle bottom, TETile fill) {
     ...
     */
    public static void joinRight(TETile[][] world, Random r, Rectangle left, Rectangle right, TETile fill) {
     ...
     * @param bottom    rectangle at the bottom
     */
    public static void joinBottom(TETile[][] world, Random r, Rectangle top, Rectangle bottom, TETile fill) {
        int start = Math.max(top.leftDown.x, bottom.leftUp.x);
        int end = Math.min(top.rightDown.x, bottom.rightUp.x);
        int pickX = RandomUtils.uniform(r, start + 1, end);
        world[pickX][top.leftDown.y] = fill;
     ...
     */
    public static void joinLeft(TETile[][] world, Random r, Rectangle left, Rectangle right, TETile fill) {
        int start = Math.max(left.rightDown.y, right.leftDown.y);
        int end = Math.min(left.rightUp.y, right.leftUp.y);
        int pickY = RandomUtils.uniform(r, start + 1, end);
        world[left.rightUp.x][pickY] = fill;
     ...
     */
    public static Rectangle generateTopNeighbor(TETile[][] world, Random r, Rectangle rtg, int width, int height, TETile t, TETile fill) {
...
//        System.out.println(topNeighbor.toString());
//        System.out.println(verifyRectangle(topNeighbor));
     ...
     * @return          the new rectangle
     */
    public static Rectangle generateRightNeighbor(TETile[][] world, Random r, Rectangle rtg, int width, int height, TETile t, TETile fill) {
...
//        System.out.println(rightNeighbor.toString());
//        System.out.println(verifyRectangle(rightNeighbor));
     ...
     * @return          the new rectangle
     */
    public static Rectangle generateBottomNeighbor(TETile[][] world, Random r, Rectangle rtg, int width, int height, TETile t, TETile fill) {
...
//        System.out.println(bottomNeighbor.toString());
//        System.out.println(verifyRectangle(bottomNeighbor));
     ...
     * @return          the new rectangle
     */
    public static Rectangle generateLeftNeighbor(TETile[][] world, Random r, Rectangle rtg, int width, int height, TETile t, TETile fill) {
...
//        System.out.println(leftNeighbor.toString());
//        System.out.println(verifyRectangle(leftNeighbor));
     ...
     */
    public static List<Rectangle> drawNeighbors(TETile[][] world, Random r, Rectangle rtg, TETile t, TETile fill) {
...
//            int x, y;
            switch (side) {
                case 0:         // top side is available
                    ...
                    break;
                case 1:         // right
                    Rectangle rightNeighbor = generateRightNeighbor(world, r, rtg, nextW, nextH, t, fill);
                    ...
                    break;
                case 2:         // bottom
                    Rectangle bottomNeighbor = generateBottomNeighbor(world, r, rtg, nextW, nextH, t, fill);
                    if (bottomNeighbor != null) {
                        newRectangles.add(bottomNeighbor);
                    }
                    break;
                case 3:         // left
                    Rectangle leftNeighbor = generateLeftNeighbor(world, r, rtg, nextW, nextH, t, fill);
            ...
            if (StdDraw.hasNextKeyTyped()) {
                ...
                if (key == 'l' || key == 'L') {
                    ...
                    if (key == 'n' || key == 'N') {
                        ...
                        drawText("Please enter seed:", Math.round(width / 2), Math.round(height / 14 * 4));
                    } else {
                        continue;
                    }
